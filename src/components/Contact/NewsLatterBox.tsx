  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Don&apos;t miss top news in the tech industry. Subscribe!
      </p>
      <div>
        <input
          type="text"
        ...
        <button
          type="submit"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-green-600 px-9 py-4 
          text-base font-medium text-white shadow-submit duration-300 hover:bg-green-800 dark:shadow-submit-dark"
        > Subscribe</button>
